...
export class InitialMigration1684250584779 implements MigrationInterface {
    name = 'InitialMigration1684250584779'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transaction_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "ref" character varying NOT NULL, "expiration" character varying NOT NULL, "amount" integer NOT NULL, "walletId" uuid, "userId" uuid, CONSTRAINT "UQ_f201d5004f4b14b0988fdd0cf55" UNIQUE ("ref"), CONSTRAINT "PK_6f9d7f02d8835ac9ef1f685a2e8" PRIMARY KEY ("id"))`);
